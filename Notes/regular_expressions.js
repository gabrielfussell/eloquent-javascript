...
Special characters such as many non latin characters and emojis will not be matched by \w (word characters)
and WILL be matched by \W (non word characters).

To account for these characters use the "u" option at the end of your regular expression.
*/

//console.log(/<.>/.test("<🌹>")); //false
//console.log(/<.>/u.test("<🌹>")); //true

//You can also use \p{property} to match on a given unicode property
console.log(/\p{Script=Greek}/u.test("βήτα"));